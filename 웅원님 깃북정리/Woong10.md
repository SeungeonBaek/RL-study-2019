...
### (1) SGD
  ...
  이런 식으로 update를 하게 되는데 모든 데이터에 대해서 gardient를 구해서 한 번 update하는 것이 아니고 Sampling을 통해서 순차적으로 update를 하겠다는 gradient descent 방법이 stochastic gradient descent입니다.
    ...
    > Algorithm of Deep Q - learning with Experience Replay
      ...
      for episode = 1 to M do
        ...
        for t = 1 to T do
          ...
          Set s_(t+1) = s_t, a_t, x_(t+1) and preprocess 𝜙_(t+1) = 𝜙(s_(t+1))
